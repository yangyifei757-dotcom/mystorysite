      ...
      <div className="max-w-md w-full bg-card p-8 rounded-2xl border border-border space-y-6">
        ...
        <div className="space-y-3">
          <button
            ...
            disabled={loading}
            className="w-full flex items-center justify-center gap-3 py-3 bg-white border border-gray-300 rounded-xl hover:bg-gray-50 transition"
          >
          ...
          <button
            ...
            disabled={loading}
            className="w-full flex items-center justify-center gap-3 py-3 bg-[#1877F2] text-white rounded-xl hover:bg-[#166fe5] transition"
          >
